...
import { Image, Keyboard, KeyboardAvoidingView, Modal, ScrollView, TextInput, TouchableOpacity, TouchableWithoutFeedback, View } from "react-native";
...
const NewjobBody = () => {
    ...
    const handleConfirm = (date) => {
        console.log(
            ...
            }${date.getMinutes()}  ${date.getDate() < 10 ? '0' : ''
